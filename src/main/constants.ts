...
// Isolate development and packaged Fluent sessions from the stock client.
// --dataDir is still handled by initializeArgs before config is loaded.
if (process.env.NODE_ENV !== 'test') {
    app.setPath('userData', path.join(app.getPath('appData'), 'Mattermost Fluent'));
}

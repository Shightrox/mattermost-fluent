...
contextBridge.exposeInMainWorld('desktop', {
    ...
    openFluentToolbar: (command) => ipcRenderer.send(FLUENT_TOOLBAR_COMMAND, command),
    getFluentHistory: () => ipcRenderer.invoke(FLUENT_HISTORY_STATUS),
    onFluentHistory: (listener) => {
        const handler = (_, status) => listener(status);
        ipcRenderer.on(FLUENT_HISTORY_STATUS, handler);
        return () => ipcRenderer.off(FLUENT_HISTORY_STATUS, handler);
    },
    ...
    openLinuxGitHubRelease: () => ipcRenderer.send(OPEN_LINUX_GITHUB_RELEASE),

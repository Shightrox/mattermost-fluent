...
declare global {
    interface Window {
        ...
        desktop: {
            ...
            openAppMenu: () => void;
            openFluentToolbar: (command: 'search' | 'tools' | 'back' | 'forward') => void;
            getFluentHistory: () => Promise<{canGoBack: boolean; canGoForward: boolean}>;
            onFluentHistory: (listener: (status: {canGoBack: boolean; canGoForward: boolean}) => void) => () => void;

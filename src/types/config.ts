...
export type ConfigV4 = {
    ...
    fluentEnabled?: boolean;
    fluentMaterial?: 'solid' | 'mica' | 'acrylic';
    fluentChatOpacity?: number;
    fluentMotion?: boolean;
    fluentAccent?: 'blue' | 'violet' | 'green' | 'teal' | 'rose' | 'amber' | 'coral' | 'indigo';
    fluentTint?: 'neutral' | 'slate' | 'ocean' | 'forest' | 'plum' | 'sand';
    fluentTextSize?: 'standard' | 'large';
    fluentTheme?: 'system' | 'light' | 'dark' | 'server';

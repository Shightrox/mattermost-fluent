...
import FluentCommands from './FluentCommands';
import FluentWorkspaceRail from './FluentWorkspaceRail';
    ...
    render() {
        ...
        return (
            <BasePage
                navigation={
                    <FluentWorkspaceRail
                        ...
                        activeServerId={this.state.activeServerId}
                        mentions={this.state.mentionsPerServer}
                        unreads={this.state.unreadsPerServer}
                        disabled={Boolean(this.state.modalOpen)}
                    />
                }
            ...
            >
                ...
                {tabsRow}
                <FluentCommands
                    disabled={Boolean(this.state.modalOpen || !this.state.currentServer?.isLoggedIn)}
                    activeTabId={this.state.activeTabId}
                />

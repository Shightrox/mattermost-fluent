...
import FluentIllustration from 'renderer/components/FluentIllustration';
    ...
    const slides = useMemo(() => [
        {
            ...
            image: (
                <FluentIllustration fallback={<ThreadsEmptyImage/>}/>
            ),
            main: true,
        },
        {
            ...
            image: (
                <FluentIllustration fallback={<CollaborateImage/>}/>
            ),
        },
        {
            key: 'calls',
            ...
            image: (
                <FluentIllustration fallback={<CallsImage/>}/>
            ),
        },
        {
            key: 'integrate',
            ...
            image: (
                <FluentIllustration fallback={<ToolsImage/>}/>
            ),
        },
    ], []);

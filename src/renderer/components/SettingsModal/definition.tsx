...
const definition: (intl: IntlShape) => Promise<SettingsDefinition> = async (intl: IntlShape) => {
    return {
        fluent: {
            title: intl.formatMessage({id: 'fluent.title', defaultMessage: 'Appearance'}),
            ...
            settings: [
                {
                    ...
                    props: {
                        label: intl.formatMessage({id: 'fluent.enabled', defaultMessage: 'Fluent appearance'}),
                        subLabel: intl.formatMessage({id: 'fluent.description', defaultMessage: 'Personal styling on this device. Turn off at any time to restore the original interface.'}),
                    },
                },
                {
                    id: 'fluentTheme',
                    ...
                    props: {
                        label: intl.formatMessage({id: 'fluent.theme', defaultMessage: 'Color theme'}),
                        options: [
                            {value: 'system', label: intl.formatMessage({id: 'fluent.themeSystem', defaultMessage: 'System'})},
                            {value: 'light', label: intl.formatMessage({id: 'fluent.themeLight', defaultMessage: 'Light'})},
                            {value: 'dark', label: intl.formatMessage({id: 'fluent.themeDark', defaultMessage: 'Dark'})},
                        ],
                    },
                },
                {
                    ...
                    component: RadioSetting,
                    props: {
                        label: intl.formatMessage({id: 'fluent.accent', defaultMessage: 'Accent color'}),
                        options: [
                            {value: 'blue', label: intl.formatMessage({id: 'fluent.accentBlue', defaultMessage: 'Sky'})},
                            {value: 'violet', label: intl.formatMessage({id: 'fluent.accentViolet', defaultMessage: 'Iris'})},
                            {value: 'green', label: intl.formatMessage({id: 'fluent.accentGreen', defaultMessage: 'Sage'})},
                            {value: 'teal', label: intl.formatMessage({id: 'fluent.accentTeal', defaultMessage: 'Teal'})},
                            {value: 'rose', label: intl.formatMessage({id: 'fluent.accentRose', defaultMessage: 'Rose'})},
                            {value: 'amber', label: intl.formatMessage({id: 'fluent.accentAmber', defaultMessage: 'Amber'})},
                            {value: 'coral', label: intl.formatMessage({id: 'fluent.accentCoral', defaultMessage: 'Coral'})},
                            {value: 'indigo', label: intl.formatMessage({id: 'fluent.accentIndigo', defaultMessage: 'Indigo'})},
                        ],
                    },
                },
                {
                    ...
                    component: RadioSetting,
                    props: {
                        label: intl.formatMessage({id: 'fluent.tint', defaultMessage: 'Window tint'}),
                        subLabel: intl.formatMessage({id: 'fluent.tintDescription', defaultMessage: 'Color beneath the glass, shared by the window, sidebar and chat. Independent of the accent color; also works with solid surfaces.'}),
                        options: [
                            {value: 'neutral', label: intl.formatMessage({id: 'fluent.tintNeutral', defaultMessage: 'Neutral'})},
                            {value: 'slate', label: intl.formatMessage({id: 'fluent.tintSlate', defaultMessage: 'Graphite'})},
                            {value: 'ocean', label: intl.formatMessage({id: 'fluent.tintOcean', defaultMessage: 'Ocean'})},
                            {value: 'forest', label: intl.formatMessage({id: 'fluent.tintForest', defaultMessage: 'Forest'})},
                            {value: 'plum', label: intl.formatMessage({id: 'fluent.tintPlum', defaultMessage: 'Plum'})},
                            {value: 'sand', label: intl.formatMessage({id: 'fluent.tintSand', defaultMessage: 'Sand'})},
                        ],
                    },
                },
                {
                    ...
                    component: RadioSetting,
                    props: {
                        label: intl.formatMessage({id: 'fluent.textSize', defaultMessage: 'Message text size'}),
                        options: [
                            {value: 'standard', label: intl.formatMessage({id: 'fluent.textStandard', defaultMessage: 'Standard'})},
                            {value: 'large', label: intl.formatMessage({id: 'fluent.textLarge', defaultMessage: 'Large'})},
                        ],
                    },
                },
                {
                    ...
                    component: RadioSetting,
                    props: {
                        label: intl.formatMessage({id: 'fluent.material', defaultMessage: 'Window material (Windows 11 22H2 or later)'}),
                        options: [
                            {value: 'solid', label: intl.formatMessage({id: 'fluent.solid', defaultMessage: 'Solid — opaque surfaces'})},
                            {value: 'mica', label: intl.formatMessage({id: 'fluent.mica', defaultMessage: 'Mica — subtle wallpaper tint'})},
                            {value: 'acrylic', label: intl.formatMessage({id: 'fluent.acrylic', defaultMessage: 'Glass — translucent acrylic'})},
                        ],
                    },
                },
                {
                    id: 'fluentChatOpacity',
                    component: RangeSetting,
                    props: {
                        label: intl.formatMessage({id: 'fluent.chatOpacity', defaultMessage: 'Chat background density'}),
                        subLabel: intl.formatMessage({id: 'fluent.chatOpacityDescription', defaultMessage: 'Lower values reveal more of the window material. Higher values darken the glass in the dark theme. Applies to Mica and Glass.'}),
                        min: 30,
                        max: 100,
                        defaultValue: 75,
                    },
                },
                {
                    ...
                    component: CheckSetting,
                    props: {
                        label: intl.formatMessage({id: 'fluent.motion', defaultMessage: 'Smooth motion'}),
                        subLabel: intl.formatMessage({id: 'fluent.motionDescription', defaultMessage: 'Gliding sidebar highlight and gentle surface transitions. Respects reduced motion in system settings.'}),
                    },
                },
            ],
        },
